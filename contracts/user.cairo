...
func increase_balance{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    ...
    user_balance.write(user_id , res + amount)
    return ()
end

@view
func get_user_id {syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (user : felt):
    let (user) = user_id.read()
    return (user)
end

@view 
func get_user_count {syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (count : felt):
    let(count) = user_count.read()
    return(count)
end
...
@view
func get_balance{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(user_id : felt) -> (
        res : felt):
    let (res) = user_balance.read(user_id)
    return (res)
end
